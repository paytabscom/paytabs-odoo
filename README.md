...
2. Copy the folder `payment_paytabs` into one of the directories listed in the `addons_path` of
...
`odoo.addons.payment_paytabs` logger, with the server key and signatures masked. Check the file
